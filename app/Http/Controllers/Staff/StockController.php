...
class StockController extends Controller
{
    public function index()
    {
        ...
        return view('staff.stocks.index', compact('products'));
    }
    ...
    public function create(Product $product)
    {
        ...
        return view('staff.stocks.create', compact('product', 'currentStock'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        return view('staff.stocks.edit', compact('product', 'currentStock'));
    }
