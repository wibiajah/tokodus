            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('superadmin.vouchers.store') }}" method="POST">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">Huruf besar, tanpa spasi</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name" value="{{ old('name') }}" required
                                        ...
                                        placeholder="Voucher Natal 2024">
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="description" rows="3"
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                        placeholder="Tulis deskripsi voucher...">{{ old('description') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">Contoh: 50000 untuk Rp 50.000 atau 10 untuk 10%</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">Jumlah maksimal voucher dapat digunakan</p>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- Quantity Discounts --}}
                        <div class="mb-8">
                            <h3 class="text-lg font-semibold text-gray-900 mb-4 border-b pb-2">📊 Diskon Berdasarkan Kuantitas (Opsional)</h3>
                            <p class="text-sm text-gray-600 mb-4">Contoh: Beli 10 pcs diskon Rp 1.000, beli 100 pcs diskon Rp 2.000</p>
