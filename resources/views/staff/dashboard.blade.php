<x-admin-layout title="Dashboard Staff Admin">
    <!-- Welcome Card -->
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <p class="mb-0">
                            Anda telah login sebagai <span class="badge bg-light text-warning">Staff Admin</span>
                            <br>
        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <p class="text-muted">Fitur orderan dan lainnya akan segera hadir...</p>
                    </div>
                </div>
            </div>
        </div>
